...
# RGB LEDs
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[0] }]; #IO_L5P_T0_D06_14 Sch=rgbleds[0]
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[1] }]; #IO_L10P_T1_D14_14 Sch=rgbleds[1]
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[2] }]; #IO_L11P_T1_SRCC_14 Sch=rgbleds[2]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[3] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=rgbleds[3]
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[4] }]; #IO_0_14 Sch=rgbleds[4]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { rgbleds[5] }]; #IO_L11N_T1_SRCC_14 Sch=rgbleds[5]
